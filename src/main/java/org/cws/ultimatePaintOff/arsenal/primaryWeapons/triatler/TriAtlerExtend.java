...
public class TriAtlerExtend {
    ...
    public void shootSecondary(Player player) {
        ...
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.5,gravityLevel/3,name,destructionTime+10,glowing,paintLength,null,true,coolDown,explosionRadius,explosionDamage,0);
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.25,gravityLevel/3,name,destructionTime+10,glowing,paintLength,null,true,coolDown,explosionRadius,explosionDamage,yawOffset/6);
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.25,gravityLevel/3,name,destructionTime+10,glowing,paintLength,null,true,coolDown,explosionRadius,explosionDamage,yawOffsetTwo/6);
    }
}
