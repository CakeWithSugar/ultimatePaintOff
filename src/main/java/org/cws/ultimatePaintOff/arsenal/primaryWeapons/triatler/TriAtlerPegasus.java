...
public class TriAtlerPegasus {
    ...
    public void shootSecondary(Player player) {
        ...
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.5,gravityLevel/3,name,destructionTime*2,glowing,paintLength,null,true,coolDown+10,explosionRadius,explosionDamage,0,randomizeYaw);
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.25,gravityLevel/3,name,destructionTime*2,glowing,paintLength,null,true,coolDown+10,explosionRadius,explosionDamage,yawOffset/6,randomizeYaw);
        instance.snowballManager.createSnowball(player,null,speedMultiplier+0.25,gravityLevel/3,name,destructionTime*2,glowing,paintLength,null,true,coolDown+10,explosionRadius,explosionDamage,yawOffsetTwo/6,randomizeYaw);
    }
}
